...
public class Test {
	public static void main(String[] args) {
		 ...
		 printList(ret);
		 List<Estudante1> lista2 = new ArrayList<Estudante1>();
		 lista2.add(new Estudante1("Andreia", 9855678, new Data(18, 7, 1974)));
		 lista2.add(new Estudante1("Monica", 75266454, new Data(11, 8, 1978)));
		 lista2.add(new Estudante1("Jose", 85265426, new Data(15, 2, 1976)));
		 lista2.add(new Bolseiro("Maria", 8976543, new Data(12, 5, 1976)));
		 lista2.add(new Bolseiro("Xico", 872356522, new Data(21, 4, 1975)));
		 System.out.println("\nEstudante Filter 1:");
		 List<Estudante1> ret2 = ListsProcess.filter(lista2, e -> e.getNMec() < 103);
		 printList(ret2);
